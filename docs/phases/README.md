...
**Status legend:** 📄 design/learning doc complete · 🔨 implementation pending (all phases, at
initial delivery — this repository is the Phase 0 documentation deliverable)
...
- **M1 — Monorepo runs** (Phase 1–2): scaffold + verified native dev workflow.
- **M2 — Core TTS works** (Phase 3–11): the product's heart; demoable.
